...
- "schema_organization": "organization.ts" | kind=code-symbol | source=packages/db/src/schema/organization.ts:L1 | neighbors=[67e5e40 feat(tenant): implement Organiz…, assignment.ts, hotel.ts, index.ts, organizationDomains, organizationDomainsRelations]
...
- "schema_hotel": "hotel.ts" | kind=code-symbol | source=packages/db/src/schema/hotel.ts:L1 | neighbors=[51fd7f6 feat(hotel): implement Hotel & …, assignment.ts, hotelAddresses, hotelBusinessDates, hotelContacts, hotels]
- "schema_index": "index.ts" | kind=code-symbol | source=packages/db/src/schema/index.ts:L1 | neighbors=[51fd7f6 feat(hotel): implement Hotel & …, 67e5e40 feat(tenant): implement Organiz…, 9f7d461 feat(identity): implement Ident…, ac91018 feat(scope): implement Hotel As…, b56cdfd feat(scaffolding): Phase 1 mono…, assignment.ts]
- "schema_user": "user.ts" | kind=code-symbol | source=packages/db/src/schema/user.ts:L1 | neighbors=[9f7d461 feat(identity): implement Ident…, assignment.ts, index.ts, organization.ts, organizations, userEmails]
...
- "commit:repo:github.com/sathish1812kh-hub/bookingengine@9f7d461dc9770396b545d4800672428e2a33bb84": "9f7d461 feat(identity): implement Identity Foundation & User Management (STORY-…" | kind=Commit | source=git | neighbors=[51fd7f6 feat(hotel): implement Hotel & …, main, ac91018 feat(scope): implement Hotel As…, users.ts, index.ts, user.ts]
- "schema_assignment": "assignment.ts" | kind=code-symbol | source=packages/db/src/schema/assignment.ts:L1 | neighbors=[ac91018 feat(scope): implement Hotel As…, userHotelAssignments, userHotelAssignmentsRelations, hotel.ts, hotels, organization.ts]
- "src_hotel_assignment_service_memoryassignmentrepository": "MemoryAssignmentRepository" | kind=code-symbol | source=packages/auth/src/hotel-assignment-service.ts:L13 | neighbors=[hotel-assignment-service.ts, AssignmentRepository, .assign(), .constructor(), .getAssignment(), .getByHotel()]
...
- "commit:repo:github.com/sathish1812kh-hub/bookingengine@ac91018ee0fc41e30d7298b487ad5688e140b3bc": "ac91018 feat(scope): implement Hotel Assignment & Access Scope (STORY-005)" | kind=Commit | source=git | neighbors=[9f7d461 feat(identity): implement Ident…, main, hotel-scope.middleware.ts, assignments.ts, assignment.ts, index.ts]
...
- "src_hotel_assignment_service_hotelassignmentservice": "HotelAssignmentService" | kind=code-symbol | source=packages/auth/src/hotel-assignment-service.ts:L92 | neighbors=[hotel-assignment-service.ts, .assignUserToHotel(), .constructor(), .getDefaultHotel(), .listAccessibleHotels(), .removeUserFromHotel()]
...
- "routes_assignments": "assignments.ts" | kind=code-symbol | source=apps/api/src/routes/assignments.ts:L1 | neighbors=[ac91018 feat(scope): implement Hotel As…, assignmentRepo, assignmentRouter, assignmentService, index.ts]
...
- "src_hotel_assignment_service": "hotel-assignment-service.ts" | kind=code-symbol | source=packages/auth/src/hotel-assignment-service.ts:L1 | neighbors=[ac91018 feat(scope): implement Hotel As…, AssignmentRepository, HotelAssignmentService, MemoryAssignmentRepository, index.ts]
